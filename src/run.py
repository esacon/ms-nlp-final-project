...
def main():
    ...
    if args.task == "train":
        ...
        data_loader = DataLoader(config["paths"]["train_data_dir"], max_articles=args.max_articles)
        ...
        data_loader = DataLoader(config["paths"]["eval_data_dir"], max_articles=args.max_articles)
